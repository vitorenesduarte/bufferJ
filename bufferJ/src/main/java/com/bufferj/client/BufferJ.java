...
public class BufferJ {
    ...
    public void destroy(String updateId) throws IOException {
        URI uri = createUri("updates/" + updateId + "/destroy");
        HttpClient.getInstance().post(uri);
    }
    
    public void destroy(Update update) throws IOException {
        destroy(update.getId());
    }
    
    public void moveToTop(String updateId) throws IOException {
        URI uri = createUri("updates/" + updateId + "/move_to_top");
        HttpClient.getInstance().post(uri);
    }
    
    public void moveToTop(Update update) throws IOException {
